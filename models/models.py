...
class University(Base):
    ...
    def __repr__(self):
        return "<University(id='{}', name='{}', students_number='{}')>".format(
            self.id, self.name, self.students_number,
        )
...
class User(Base):
    ...
    university = relationship("University", backref="university",
...
class UserAction(Base):
    ...
    action_name = relationship("Action", backref="user_action_name",
                               foreign_keys=[action])
...
class Timer(Base):
    ...
    def __repr__(self):
        return "<Timer(chat_id='%s', hour='%s')>".format(
            self.chat_id, self.hour
        )
